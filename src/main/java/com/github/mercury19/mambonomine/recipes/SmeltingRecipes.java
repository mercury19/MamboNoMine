...
public class SmeltingRecipes 
{
	...
	{
		GameRegistry.addSmelting(new ItemStack(BlockInit.COPPER_ORE), new ItemStack(ItemInit.COPPER.getIngot()), 0.5f);
		//GameRegistry.addSmelting(new ItemStack(BlockInit.TIN_ORE), new ItemStack(ItemInit.TIN.getIngot()), 0.5f);
